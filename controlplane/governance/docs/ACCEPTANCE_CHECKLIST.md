...
- 測試人員: AI Agent
- 結果: ✅ 通過
- 備註: 失敗時自動在 PR 留言附上 validation.report.md 並上傳 artifact
...
- 測試人員: AI Agent
- 結果: ✅ 通過
- 備註: 自動寫入最近變更摘要（新增/修改/刪除與檔案列表）

#### 驗收標準
- [x] 合併到 main 時自動觸發
- [x] 能正確分析變更類型
- [x] 能提取關鍵資訊
- [x] 能更新 PROJECT_MEMORY.md
- [x] 能更新 CONVERSATION_LOG.md
...
- 測試人員: AI Agent
- 結果: ✅ 通過
- 備註: auto-memory-update.yml 生成 controlplane / workspace 檔案樹並提交到 ARCHITECTURE.md

#### 驗收標準
- [x] 檔案結構變更時自動觸發
- [x] 能正確分析目錄結構
- [x] 能更新 ARCHITECTURE.md
- [x] 能生成檔案樹圖
- [x] 能自動提交變更
...
- **影響**: 可能無法檢測錯誤的資源配置
- **狀態**: 🟢 已驗證
- **測試計劃**: 已在 2025-12-25 自動驗證流程中覆蓋資源約束案例
...
- **影響**: 不確定是否真的能阻擋不合規 PR
- **狀態**: 🟢 已驗證
- **測試計劃**: gate-root-specs.yml / gate-root-naming.yml 於 2025-12-25 驗證並在 PR 留言報告
