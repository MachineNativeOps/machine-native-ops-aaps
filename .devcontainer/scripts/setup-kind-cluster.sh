...
echo "  • Multi-cluster:     .devcontainer/scripts/multi-cluster-manager.sh"
echo "  • Health check:      tail -f /tmp/kind-cluster-health.log"
echo "  • Run tests:         .devcontainer/scripts/run-tests.sh"
echo "  • GitOps setup:      .devcontainer/scripts/setup-gitops.sh"
echo ""
